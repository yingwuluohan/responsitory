...
import static io.netty.handler.codec.rtsp.RtspHeaders.Names.EXPIRES;
...
public class DBServerHandler extends SimpleChannelInboundHandler<HttpObject> {
    ...
    static {
        DiskFileUpload.baseDirectory = "D://nio.rar";//DBConfig.curHost.getZipPath();
    }
    @Override
...
//            }
    ...
    private void writeResponse(Channel channel, HttpResponseStatus httpResponseStatus, String returnMsg) {
        ...
        String resultStr = "节点【"+ System.getenv()+"】";
