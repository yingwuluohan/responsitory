...
import com.common.utils.framework.monitor.remote.LogMessage;
...
public class Router {
    ...
    public void init(String addressStr, GenericObjectPool.Config poolConfig, int timeout, String password, int database){
    ...
    public void addDataSource(String address, GenericObjectPool.Config poolConfig, int timeout, String password, int database){
        addDataSourceForUser(address, poolConfig, timeout, password, database);
        addDataSourceForHealthCheck(address, password, database);
    }

    private void addDataSourceForUser(String address, GenericObjectPool.Config poolConfig, int timeout, String password, int database){
